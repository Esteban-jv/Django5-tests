...
SECRET_KEY = 'django-insecure-)cjjwm*_wy46o4pd42v(0b8)z^)=!mmfkc+^ur=*(ds3(&4e%_'
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_AUTHENTICATION_CLASSES': [ # Métodos de autenticación
        ...
        # 'rest_framework.authentication.TokenAuthentication', # Recomendado para la API
    ],
    'DEFAULT_PERMISSION_CLASSES': [ # Permisos de autenticación
